...
class Welcome(object):
    ...
    def __init__(self, root):
        self._images.append(tkinter.PhotoImage('vtu.gif', file = 'vtu.gif'))
        self._images.append(tkinter.PhotoImage('zx.gif', file = 'zx.gif'))
        ...
        self._label_4 = tkinter.Label(root,
            ...
            foreground = "#ff0033",
            text = "\u00A9 copyright protected 2022-2023",)
